...
import ImageGrid from '@/app/components/image/image-grid';
...
type JournalEntryComponentProps = {
  ...
  initialEntryImages: MediaItemUrl[],
  initialAudioData: MediaItemUrl[], 
}
export default function JournalEntryComponent({ entryData, initialEntryImages, initialAudioData }: JournalEntryComponentProps) {
