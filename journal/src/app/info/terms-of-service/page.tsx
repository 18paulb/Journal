        ...
        <CardContent>
          <ScrollArea className="h-[600px] pr-4">
            <div className="prose prose-gray max-w-none dark:prose-invert">
              <p className="text-lg">
                Welcome to Journal App (&quot;the App&quot;). By accessing or using the App, you
              ...
              <section className="mt-8">
                ...
                <p>
                  The App is provided on an &quot;as-is&quot; and &quot;as-available&quot; basis for
                  personal use only.
                </p>
              ...
              <section className="mt-8">
                ...
                <p>
                  While we take reasonable measures to safeguard user data, we do not guarantee the
                  preservation or security of any data stored in the App.
                </p>
                <p>
                  You acknowledge that any data entered into the App is done at your own risk, and
                  we are not responsible for any data loss, corruption, or unauthorized access.
                </p>
                <p>
                  We strongly recommend that you keep your own backups of important journal entries.
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="uppercase">
                  ...
                  including but not limited to loss of data, loss of profits, or any other
                ...
                <p className="uppercase">
                  ...
                  special, or consequential damages arising out of or in connection with the use of
                  the app.
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p className="uppercase">
                  The app is provided &quot;as is,&quot; without any warranties of any kind, express
              ...
              <section className="mt-8">
                ...
                <p>
                  You are responsible for ensuring that your use of the App complies with all
              ...
              <section className="mt-8">
                ...
                <p>
                  We may terminate or suspend your access to the App at our discretion, without
              ...
              <section className="mt-8">
                ...
                <p>
                  These Terms are governed by the laws of California, without regard to its conflict
                  of law principles.
                </p>
              </section>
