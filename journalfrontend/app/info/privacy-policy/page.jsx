            ...
            <div className="prose prose-gray max-w-none dark:prose-invert">
              <Alert className="mb-8">
                ...
                <AlertDescription>
                  ...
                  and protect your personal information when you use Journal App (&quot;the
                  App&quot;).
                </AlertDescription>
              </Alert>
              ...
              <section className="mt-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p>
                      Your journal entries are stored securely but are not encrypted end-to-end. We
                      recommend keeping backups of important entries.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      We may collect anonymous data about how you use the App, such as logins,
                      features accessed, and device information.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="mt-8">
                ...
                <p>
                  The App may use third-party services (such as cloud storage or analytics
              ...
              <section className="mt-8">
                ...
                <p>
                  We retain your personal data as long as your account is active. If you delete your
                  account, we will remove your data within a reasonable timeframe.
                </p>
              </section>
              ...
              <section className="mt-8">
                ...
                <p>
                  You may request access to, modification of, or deletion of your data by contacting
                  us at{' '}
